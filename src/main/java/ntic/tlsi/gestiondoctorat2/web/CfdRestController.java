...
@RestController
@RequestMapping("/Restcfd")
public class CfdRestController extends BaseController{
    private final serviceUser serviceUser;

    @Autowired
    public CfdRestController(ntic.tlsi.gestiondoctorat2.service.serviceUser serviceUser) {
